...
$msg="The Following is ready to be inspected at your sooner convenience:\n Project: ".$row_datos_proyecto['nombre']." \n Work: ".$row_nombre_trabajo['work']." ".$cadena_correo." Sent By: ".$row_usuario_notificacion['nombre']." \n Important: ".$row_correo_notificacion['important_note']." \n\n Quality Control Dept. \n Estelar Construction Ltd. \n (780) 782-3677";
...
<body>
	...
	<table>
		<tr><td>PROJECT:</td><td>".$row_datos_proyecto['nombre']."</td></tr>
	...
	if($bandera_imagenes==1)
		{  foreach($a_imagenes as $key=>$valor)
			{  $mensaje.="<p><img src='http://estelarconstruction.com/estelar/images/".$valor."'></p>";
			}
