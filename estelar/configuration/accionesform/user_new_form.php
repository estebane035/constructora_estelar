...
//GUARDA USUARIO
mysql_query("insert into usuarios(nombre,idtipousuario,fecharegistro,horaregistro,activo) values('".strtoupper(mysql_real_escape_string($name))."','".$type."','".date('Y-m-d')."','".date('H:i:s')."','1')",$conexionbase) or die(mysql_error());
