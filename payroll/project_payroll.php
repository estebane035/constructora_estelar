...
$objPHPExcel->getActiveSheet()->setCellValue('B'.$row_count, 'Nombre proyecto PAYROLL');




// Renombrar Hoja
$objPHPExcel->getActiveSheet()->setTitle('Nombre proyecto PAYROLL');
...
header('Content-Disposition: attachment;filename="nombre_payroll.xlsx"');
